...
export const MODULI = [
    ...
    },
    {
        ...
        descrizione: 'Trasmissione e ricezione live delle cartelle cliniche e atti odontoiatrici sulle postazioni dello studio',
        simbolo: 'monitor',
        accento: 'pazienti',
        permesso: ['trasmissione_invia', 'trasmissione_ricevi'],
        modulo: () => import(`./views/trasmissione.js${versione()}`)
    },
    {
        id: 'mia_scheda',
        titolo: 'La mia scheda',
        descrizione: 'Il tuo profilo di collaboratore: appuntamenti, produzione e competenze maturate',
        simbolo: 'account_circle',
        accento: 'staff',
        permesso: 'staff_view',
        modulo: () => import(`./views/mia_scheda.js${versione()}`)
    },
    {
        id: 'struttura',
...
export const VISTE_INTERNE = {
    postazioni: {
        ...
        accento: 'struttura',
        permesso: 'rete_view',
        genitore: 'trasmissione',
        modulo: () => import(`./views/postazioni.js${versione()}`)
    },
    paziente: {
